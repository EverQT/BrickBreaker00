...
AEnemyWithPattern::AEnemyWithPattern()
{
	// Set this pawn to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;
}

void AEnemyWithPattern::CharacteristicsEnemyBrick()
{
	// mensajes
	GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Yellow, FString::Printf(TEXT("Con velocidad de: %f"), VelocityBrick));
